...
export const Blob: FC<SphereProps> = ({ setBg }) => {
  ...
  useFrame(({ mouse, clock }) => {
    ...
    if (sphere.current?.position) {
      ...
      sphere.current.rotation.x += rotationCalculation(
        Number(rotation.animation.to),
        clock.elapsedTime
      )
      sphere.current.rotation.y += rotationCalculation(
        Number(rotation.animation.to),
        clock.elapsedTime
      )
      sphere.current.rotation.z += rotationCalculation(
        Number(rotation.animation.to),
        clock.elapsedTime
      )
    }
